$(function() {
    ...
    str += '.showswt{ width: 100%;height: 100%;position: fixed;left: 0;top: 0;z-index: 30000;background: rgba(0, 0, 0, .4);}';
    str += '.float_container { width: 500px;height: 540px;background: url(/include/Images/swtimg/swtbg.png)no-repeat center center; border-radius: 10px;z-index: 1000;position: fixed; left: 50%; bottom:14%; margin-left: -250px;font-size: 14px; z-index: 999999999; padding-bottom: 5px; display: none;overflow: hidden; border-radius: 0px 0px 20px 20px;}';
