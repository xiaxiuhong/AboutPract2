(function (w, d) {
  var sub = d.getElementById('kbj-header-sub'),
      product = d.getElementById('kbj-header-link-product'),
...
$(function () {
  var product = $('#kbj-header-link-product'),
      subnav = $('#kbj-header-sub'),
      nav = $('nav');
      show = function () {
...
(function (w, d) {
  var sub = d.getElementById('kbj-header-sub1'),
      product = d.getElementById('kbj-header-link-product1'),
      addHandle = function (element, type, handler) {
        if (element.addEventListener) {
          element.addEventListener(type, handler, false);
        } else if (element.attachEvent) {
...
$(function () {
  var product = $('#kbj-header-link-product1'),
      subnav = $('#kbj-header-sub1'),
      nav = $('nav');
      show = function () {
        product.addClass('hover');
        subnav.stop().slideDown();
...
(function (w, d) {
  var sub = d.getElementById('kbj-header-sub2'),
      product = d.getElementById('kbj-header-link-product2'),
      addHandle = function (element, type, handler) {
        if (element.addEventListener) {
          element.addEventListener(type, handler, false);
        } else if (element.attachEvent) {
...
$(function () {
  var product = $('#kbj-header-link-product2'),
      subnav = $('#kbj-header-sub2'),
      nav = $('nav');
      show = function () {
        product.addClass('hover');
        subnav.stop().slideDown();
        nav.addClass('toggle2');
      },
      hide = function () {
        product.removeClass('hover');
        subnav.stop().slideUp(function () {
          nav.removeClass('toggle2');
        });
      };
  product.mouseover(show);
  subnav.mouseover(show);
